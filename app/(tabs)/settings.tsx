    ...
    <ScrollView style={styles.tabContent}>
      <View style={styles.section}>
        ...
        <Text style={styles.privacyText}>
          ...
          {"\n"}• CLOTHING IMAGES ARE NOT SENT TO AI SERVICES - ONLY TEXT DESCRIPTIONS
        ...
        <Text style={styles.privacyText}>
          ...
          {"\n"}• INTERNET ACCESS: TO UPLOAD IMAGES TO CLOUD STORAGE, SYNC DATA, AND ACCESS AI SERVICES
          {"\n\n"}ALL IMAGES ARE STORED LOCALLY ON YOUR DEVICE AND OPTIONALLY UPLOADED TO SECURE CLOUD STORAGE WHEN SYNC IS ENABLED. IMAGES ARE NEVER SHARED WITH AI SERVICES - ONLY TEXT DESCRIPTIONS OF YOUR CLOTHING ARE USED FOR AI OUTFIT GENERATION.
        </Text>
